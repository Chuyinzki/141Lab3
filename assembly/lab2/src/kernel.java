...
class kernel{
    ...
    public static enum opcodes {
		ADDU, SUBU, SLLV, SRAV, SRLV, AND, OR, NOR, SLT, SLTU, MOV, LW, LBU, SW, SB, JALR, LBR, RBR, XOR, NOP,
	...
	public static void initialization() throws IOException {
		...
		opcodeTable.put("LBR"  , "01011");
		opcodeTable.put("RBR"  , "10100");
		opcodeTable.put("XOR"  , "10101");
